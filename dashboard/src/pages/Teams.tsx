...
import { api, type WorkforceTeam } from '../services/api';
...
export default function Teams() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-white mb-1">Workforce Teams</h2>
      <p className="text-gray-500 text-sm mb-6">Pre-built bundles of agents, specialties, and templates for common team configurations</p>
          ...
          <div key={pkg.name} className="bg-navy rounded-lg border border-gray-800 p-6">
            ...
            <div className="flex gap-4 mb-4">
              ...
              <div className="px-3 py-1.5 bg-emerald/10 rounded text-xs text-emerald">
                {pkg.specialties.length} specialties
              </div>
            ...
            {/* Specialties */}
            {pkg.specialties.length > 0 && (
              <div className="mb-3">
                <p className="text-gray-500 text-xs mb-1.5">Specialties:</p>
                <div className="flex flex-wrap gap-1.5">
                  {pkg.specialties.map((s) => (
