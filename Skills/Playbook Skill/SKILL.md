...
## Purpose
Generates professional, interactive HTML playbook documents that match the Dev Labs design system exactly. Every playbook produced by this skill uses the same layout, typography, color palette, and component library as the reference template.
