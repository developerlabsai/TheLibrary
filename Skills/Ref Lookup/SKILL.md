...
## MCP Dependency
This skill requires the **ref.tools MCP server** to be configured. It provides up-to-date documentation lookup for APIs, libraries, frameworks, and services, optimized for coding agents.
